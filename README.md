...
urban river with inverse modelling* by Chrapkiewicz et al. (submitted to Science of the Total Environment), preprint available: [doi:...](https://dx.doi.org/10.2139/ssrn.4697195)
...
## Installing `riverpy`
Make sure to install `jupconfig`, `plotea`, `iogeo` repositories of `kmch`'s and `autocatchments`, `compysitional`, `faster-unmixer` and `thames-sewage` of Alex Lipp's.
